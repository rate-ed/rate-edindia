                    ...
                    return (
                      <label
                        ...
                        className={`flex items-center justify-between w-full px-8 py-6 rounded-3xl cursor-pointer transition-all border-[3px] ${
                          isSelected
                            ? "bg-[#13A699] text-white border-[#13A699] shadow-2xl"
                      ...
                      >
                        ...
                        <div className="relative flex items-center">
                          <input
                            type="checkbox"
                            className="peer h-12 w-12 cursor-pointer appearance-none rounded-2xl border-4 border-[#FFD708] transition-all checked:bg-white checked:border-white focus:outline-none"
                            checked={isSelected}
                            onChange={() => toggle(item.name)}
                          />
                          <svg
                            className="absolute h-8 w-8 pointer-events-none hidden peer-checked:block text-[#13A699] left-2 top-2"
