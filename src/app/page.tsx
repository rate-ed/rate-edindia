...
export default function Home() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 overflow-x-hidden">
      ...
      {/* Graphical Step Section with Mini Icons and Large Text */}
      <div className="mb-24">
          ...
          {[
            {
              ...
              icon: (
                <svg className="w-3 h-3 text-[#13A699]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            },
            {
              ...
              icon: (
                <svg className="w-3 h-3 text-[#13A699]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              )
            },
            {
            ...
            <div key={i} className="text-center group">
              <div className="w-6 h-6 bg-[#FFD708] rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm group-hover:scale-110 transition-transform duration-300">
                {item.icon}
              </div>
              <h3 className="text-[#13A699] font-black text-4xl md:text-5xl mb-6 tracking-tight">{item.title}</h3>
      ...
      <div className="relative bg-[#13A699] rounded-[3rem] p-12 text-center shadow-2xl overflow-hidden">
        ...
        <h2 className="text-4xl font-black text-white mb-6">Are you a Teacher?</h2>
